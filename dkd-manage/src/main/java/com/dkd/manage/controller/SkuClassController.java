 ...
 */
@RestController
@RequestMapping("/manage/skuCclass")
public class SkuClassController extends BaseController
{
     ...
     * 查询商品类型列表
     */
    @PreAuthorize("@ss.hasPermi('manage:skuCclass:list')")
    @GetMapping("/list")
     ...
     * 导出商品类型列表
     */
    @PreAuthorize("@ss.hasPermi('manage:skuCclass:export')")
     ...
     * 获取商品类型详细信息
     */
    @PreAuthorize("@ss.hasPermi('manage:skuCclass:query')")
     ...
     * 新增商品类型
     */
    @PreAuthorize("@ss.hasPermi('manage:skuCclass:add')")
     ...
     * 修改商品类型
     */
    @PreAuthorize("@ss.hasPermi('manage:skuCclass:edit')")
     ...
     * 删除商品类型
     */
    @PreAuthorize("@ss.hasPermi('manage:skuCclass:remove')")
