...
public class VmTypeController extends BaseController
{
     ...
     * 查询设备类型管理列表
     */
    @PreAuthorize("@ss.hasPermi('manage:vmTtype:list')")
    @GetMapping("/list")
     ...
     * 导出设备类型管理列表
     */
    @PreAuthorize("@ss.hasPermi('manage:vmTtype:export')")
     ...
     * 获取设备类型管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('manage:vmTtype:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增设备类型管理
     */
    @PreAuthorize("@ss.hasPermi('manage:vmTtype:add')")
     ...
     * 修改设备类型管理
     */
    @PreAuthorize("@ss.hasPermi('manage:vmTtype:edit')")
     ...
     * 删除设备类型管理
     */
    @PreAuthorize("@ss.hasPermi('manage:vmTtype:remove')")
